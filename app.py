...
st.markdown("""
<h4 style='color: #1F1F1F; text-shadow: 1px 1px 2px #999;'>
    💵 Enter Your Total Budget For The Course (USD)
</h4>
<p style='font-size: 13px; color: #555; margin-top: -10px;'>
    (including all other expenses like rent, insurance, visa, etc.)
</p>
""", unsafe_allow_html=True)

budget = st.number_input("", min_value=5700, max_value=200000, value=100000)
...
if st.button("🔍 Get Recommendations"):
    ...
    <div style='
        ...
        margin-top: 20px;
    '>
        ⚠️ No universities found for your selected options.<br>
        Try changing the program, country, or level.
    </div>
    """,
    unsafe_allow_html=True)
    else:
